"""
Django settings for ranking_padel project.
...
INSTALLED_APPS = [
    ...
    # 'django_tables2',
    # Locals
    'applications.jugadores',
    'applications.torneos',
    'applications.puntos',
    'applications.posiciones',
...
ROOT_URLCONF = 'ranking_padel.urls'
...
WSGI_APPLICATION = 'ranking_padel.wsgi.application'
